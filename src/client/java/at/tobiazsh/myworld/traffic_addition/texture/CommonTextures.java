...
public class CommonTextures {
    ...
    public static Texture INTERNET_GLOBE = null;
    ...
    public static void loadTextures() {
        ...
        INTERNET_GLOBE = Textures.smartRegisterTexture("assets/myworld_traffic_addition/textures/imgui/icons/internet_globe.png");
    }
}
