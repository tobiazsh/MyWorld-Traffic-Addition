...
public class ServerPreferencesManager {
    ...
    public static PreferenceJsonLoader generalServerPreferences = new PreferenceJsonLoader("myworld_traffic_addition/server_config.json");
    ...
    public static short maxCustomizableSignElements = 30;
    public static final short maxCustomizableSignElementsDefault = 30;
    ...
    public static void loadPreferences() {
        ...
        Short MCustomizableSignElements = generalServerPreferences.getShort(maxCustomizableSignElementsKey);
        maxCustomizableSignElements = Objects.requireNonNullElse(MCustomizableSignElements, maxCustomizableSignElementsDefault);
    }
}
