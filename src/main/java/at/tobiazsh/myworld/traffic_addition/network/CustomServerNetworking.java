...
public class CustomServerNetworking extends CustomNetworking<BiConsumer<ServerPlayer, byte[]>> {
     ...
     */
    public void sendBytesToClient(ServerPlayer player, Identifier channelName, byte[] dataBytes, long rate, int chunkSize) {
     ...
     * Does not limit transmission speed or chunk size! Use {@link #sendBytesToClient(ServerPlayer, Identifier, byte[], long, int)} for that.
     */
    public void sendStringToClient(ServerPlayer player, Identifier identifier, String data) {
